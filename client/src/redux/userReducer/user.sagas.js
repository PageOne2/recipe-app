...
export function* logUser({payload}) {
  try {
    const apiUrl = process.env.NODE_ENV === 'production' ? `${process.env.API_URL}/users/login` : 'http://localhost:3000/api/users/login';
...
export function* signUp({payload}) {
  try {
    const apiUrl = process.env.NODE_ENV === 'production' ? `${process.env.API_URL}/users/signup` : 'http://localhost:3000/api/users/signup';
    let data = yield fetch(apiUrl, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
...
export function* getMe() {
  try {
    const apiUrl = process.env.NODE_ENV === 'production' ? `${process.env.API_URL}/users/me` : 'http://localhost:3000/api/users/me';
    let data = yield fetch(apiUrl, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
...
export function* updateUserPassword({payload}) {
  try {
    const apiUrl = process.env.NODE_ENV === 'production' ? `${process.env.API_URL}/users/updateMyPassword` : 'http://localhost:3000/api/users/updateMyPassword';
    let data = yield fetch(apiUrl, {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json',
...
export function* getMyRecipes() {
  try {
    const apiUrl = process.env.NODE_ENV === 'production' ? `${process.env.API_URL}/users/myRecipes` : 'http://localhost:3000/api/users/myRecipes';
    let data = yield fetch(apiUrl, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
...
export function* likeRecipe({payload}) {
  try {
    const apiUrl = process.env.NODE_ENV === 'production' ? `${process.env.API_URL}/users/likeRecipe/${payload}` : `http://localhost:3000/api/users/likeRecipe/${payload}`;
    let data = yield fetch(apiUrl, {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json',
...
export function* dislikeRecipe({payload}) {
  try {
    const apiUrl = process.env.NODE_ENV === 'production' ? `${process.env.API_URL}/users/dislikeRecipe/${payload}` : `http://localhost:3000/api/users/dislikeRecipe/${payload}`;
    let data = yield fetch(apiUrl, {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json',
